...
5. [Crime and vandalism subdomain](#crime-subdomain)  
...
**Variable description**: Members of community in which participant lives is close-knit (i.e. neighbourhood solidarity).    
**Value type**: integer      
**Variable unit**: N/A       
**Category coding**:  
...
**Code** | **Category Label**  
------------- | -------------  
1 | Definitely neighbourhood solidarity     
...
```
### **Variable label**: Neighbourhood noisy (2-level)     
**Variable name**:  env_nbh_noise_0  

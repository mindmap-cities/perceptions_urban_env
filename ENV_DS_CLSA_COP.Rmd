...
# CLSA-cop_0
opal.assign.table.tibble(erasmus_opal, 'CoP4_Baseline', 'CLSA_1.CoP4_Baseline', variables = list('ENV_PPLTRST_MCQ','ENV_PPLHLP_MCQ','ENV_PPLFRNDLY_MCQ','ENV_CLEAN_MCQ','ENV_HMPRB_NOI_MCQ','ENV_VNDLSM_MCQ'))
CoP4_Baseline <- opal.execute(erasmus_opal,'CoP4_Baseline')
# CLSA-cop_1
opal.assign.table.tibble(erasmus_opal, 'CoP_FU1', 'CLSA_1.CoP_FU1', variables = list('ENV_PPLTRST_COF1','ENV_PPLHLP_COF1','ENV_PPLFRNDLY_COF1','ENV_CLEAN_COF1','ENV_HMPRB_NOI_COF1','ENV_VNDLSM_COF1','SPA_COHES_COF1'))
CoP_FU1 <- opal.execute(erasmus_opal,'CoP_FU1')

opal.assign.table.tibble(erasmus_opal, 'soc_var_view_cop_baseline', 'CLSA_1.soc_var_view_cop_baseline')
cop_baseline_v <- opal.execute(erasmus_opal,'soc_var_view_cop_baseline')

opal.assign.table.tibble(erasmus_opal, 'soc_var_view_cop_FU', 'CLSA_1.soc_var_view_cop_FU')
cop_FU1_v <- opal.execute(erasmus_opal,'soc_var_view_cop_FU')
...
CoP4_Baseline<-merge(CoP4_Baseline, cop_baseline_v, by="id", all=TRUE)
CoP_FU1<-merge(CoP_FU1, cop_FU1_v, by="id", all=TRUE)

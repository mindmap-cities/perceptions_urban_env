...
soc_CLSA_tra0$env_nbh_trust_0 <- ifelse(Tra3_4_Baseline$ENV_PPLTRST_MCQ ==1 | Tra3_4_Baseline$ENV_PPLTRST_MCQ ==2,1L, 
                                           ifelse(Tra3_4_Baseline$ENV_PPLTRST_MCQ ==3 | Tra3_4_Baseline$ENV_PPLTRST_MCQ ==4,0L,NA))

table(soc_CLSA_tra0$env_nbh_trust_0, useNA="always") 
```
### **Variable label**:  Neighbourhood  trust  
...
soc_CLSA_tra1$env_nbh_trust_1 <- ifelse(Tra_FU1$ENV_PPLTRST_TRF1 ==1 | Tra_FU1$ENV_PPLTRST_TRF1 ==2,1L, 
                                           ifelse(Tra_FU1$ENV_PPLTRST_TRF1 ==3 | Tra_FU1$ENV_PPLTRST_TRF1 ==4,0L,NA))

table(soc_CLSA_tra1$env_nbh_trust_1, useNA="always") 
```
### **Variable label**:  Neighbourhood  trust  
...
soc_CLSA_tra0$env_nbs_coop_0 <- ifelse(Tra3_4_Baseline$ENV_PPLHLP_MCQ ==1 |Tra3_4_Baseline$ENV_PPLHLP_MCQ ==2,1L, 
                                           ifelse(Tra3_4_Baseline$ENV_PPLHLP_MCQ ==3 |Tra3_4_Baseline$ENV_PPLHLP_MCQ ==4,0L,NA))

table(soc_CLSA_tra0$env_nbs_coop_0, useNA="always") 
...
soc_CLSA_tra1$env_nbs_coop_1 <- ifelse(Tra_FU1$ENV_PPLHLP_TRF1 ==1 |Tra_FU1$ENV_PPLHLP_TRF1 ==2,1L, 
                                           ifelse(Tra_FU1$ENV_PPLHLP_TRF1 ==3 |Tra_FU1$ENV_PPLHLP_TRF1 ==4,0L,NA))

table(soc_CLSA_tra1$env_nbs_coop_1, useNA="always") 
```
...
soc_CLSA_tra0$env_nbs_friendly_0 <- ifelse(Tra3_4_Baseline$ENV_PPLFRNDLY_MCQ ==1,1L, 
...
table(soc_CLSA_tra0$env_nbs_friendly_0, useNA="always") 
```
...
soc_CLSA_tra1$env_nbh_belong_1 <- ifelse(Tra_FU1$SPA_COHES_TRF1 ==1 | Tra_FU1$SPA_COHES_TRF1==2,1L, 
                                            ifelse(Tra_FU1$SPA_COHES_TRF1==3 | Tra_FU1$SPA_COHES_TRF1==4,0L,NA))

table(soc_CLSA_tra1$env_nbh_belong_1, useNA="always") 
```
### **Variable label**: Belonging to neighbourhood        
...
soc_CLSA_tra0$env_nbh_lone_0 <- ifelse(Tra3_4_Baseline$ENV_FLLNLY_MCQ ==1,1L, 
...
table(soc_CLSA_tra0$env_nbh_lone_0, useNA="always") 
```
### **Variable label**: Lonely in neighbourhood        
...
soc_CLSA_tra1$env_nbh_lone_1 <- ifelse(Tra_FU1$ENV_FLLNLY_TRF1 ==1,1L, 
...
table(soc_CLSA_tra1$env_nbh_lone_1, useNA="always") 
```
### **Variable label**: Lonely in neighbourhood        
...
soc_CLSA_tra0$env_nbh_clean_0 <- ifelse(Tra3_4_Baseline$ENV_CLEAN_MCQ ==1,4L, 
...
table(soc_CLSA_tra0$env_nbh_clean_0) 
```
### **Variable label**: Neighbourhood cleanliness   
...
soc_CLSA_tra1$env_nbh_clean_1 <- ifelse(Tra_FU1$ENV_CLEAN_TRF1 ==1,4L, 
                                           ifelse(Tra_FU1$ENV_CLEAN_TRF1==2,3L,
                                            ifelse(Tra_FU1$ENV_CLEAN_TRF1==3,2L,
                                                   ifelse(Tra_FU1$ENV_CLEAN_TRF1==4,1L,NA))))

table(soc_CLSA_tra1$env_nbh_clean_1, useNA="always") 
```
...
soc_CLSA_tra0$env_nbh_clean_0 <- ifelse(Tra3_4_Baseline$ENV_CLEAN_MCQ ==1 | Tra3_4_Baseline$ENV_CLEAN_MCQ==2,1L, 
                                            ifelse(Tra3_4_Baseline$ENV_CLEAN_MCQ==3 | Tra3_4_Baseline$ENV_CLEAN_MCQ==4,0L,NA))

table(soc_CLSA_tra0$env_nbh_clean_0, useNA="always") 
```
### **Variable label**: Neighbourhood cleanliness dichotomized     
...
soc_CLSA_tra1$env_nbh_clean_1 <- ifelse(Tra_FU1$ENV_CLEAN_TRF1 ==1 | Tra_FU1$ENV_CLEAN_TRF1==2,1L, 
...
soc_CLSA_tra0$env_nbh_noise_dich_0 <- ifelse(Tra3_4_Baseline$ENV_HMPRB_NOI_MCQ ==1,0L, 
                                            ifelse(Tra3_4_Baseline$ENV_HMPRB_NOI_MCQ==0,1L,NA))

table(soc_CLSA_tra0$env_nbh_noise_dich_0, useNA="always") 
```
### **Variable label**: Neighbourhood noisiness (2-level)     
...
soc_CLSA_tra1$env_nbh_noise_dich_1 <- ifelse(Tra_FU1$ENV_HMPRB_NOI_TRF1 ==1,0L, 
                                            ifelse(Tra_FU1$ENV_HMPRB_NOI_TRF1==0,1L,NA))

table(soc_CLSA_tra1$env_nbh_noise_dich_1, useNA="always") 
```
...
soc_CLSA_tra0$env_nbh_gv_0 <- ifelse(Tra3_4_Baseline$ENV_VNDLSM_MCQ ==1 | Tra3_4_Baseline$ENV_VNDLSM_MCQ==2,1L, 
                                            ifelse(Tra3_4_Baseline$ENV_VNDLSM_MCQ==3 | Tra3_4_Baseline$ENV_VNDLSM_MCQ==4,0L,NA))

table(soc_CLSA_tra0$env_nbh_gv_0, useNA="always") 
```
### **Variable label**: Neighbourhood graffiti and vandalism  
...
soc_CLSA_tra1$env_nbh_gv_1 <- ifelse(Tra_FU1$ENV_VNDLSM_TRF1 ==1 | Tra_FU1$ENV_VNDLSM_TRF1==2,1L, 
                                            ifelse(Tra_FU1$ENV_VNDLSM_TRF1==3 | Tra_FU1$ENV_VNDLSM_TRF1==4,0L,NA))

table(soc_CLSA_tra1$env_nbh_gv_1, useNA="always") 
```
### **Variable label**: Neighbourhood graffiti and vandalism    

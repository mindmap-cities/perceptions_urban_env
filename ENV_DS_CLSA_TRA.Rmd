...
# CLSA-tra_0
opal.assign.table.tibble(erasmus_opal, 'Tra3_4_Baseline', 'CLSA_1.Tra3_4_Baseline', variables = list('ENV_PPLTRST_MCQ','ENV_PPLHLP_MCQ','ENV_PPLFRNDLY_MCQ','ENV_CLEAN_MCQ','ENV_HMPRB_NOI_MCQ','ENV_VNDLSM_MCQ'))
Tra3_4_Baseline <- opal.execute(erasmus_opal,'Tra3_4_Baseline')
# CLSA-tra_1
opal.assign.table.tibble(erasmus_opal, 'Tra_FU1', 'CLSA_1.Tra_FU1', variables = list('ENV_PPLTRST_TRF1','ENV_PPLHLP_TRF1','ENV_PPLFRNDLY_TRF1','ENV_CLEAN_TRF1','ENV_HMPRB_NOI_TRF1','ENV_VNDLSM_TRF1','SPA_COHES_TRF1'))
Tra_FU1 <- opal.execute(erasmus_opal,'Tra_FU1')

opal.assign.table.tibble(erasmus_opal, 'soc_var_view_tra_baseline', 'CLSA_1.soc_var_view_tra_baseline')
Tra_baseline_v <- opal.execute(erasmus_opal,'soc_var_view_tra_baseline')

opal.assign.table.tibble(erasmus_opal, 'soc_var_view_tra_FU', 'CLSA_1.soc_var_view_tra_FU')
Tra_FU1_v <- opal.execute(erasmus_opal,'soc_var_view_tra_FU')
...
```{r, echo=FALSE}
Tra3_4_Baseline<-merge(Tra3_4_Baseline, Tra_baseline_v, by="id", all=TRUE)
Tra_FU1<-merge(Tra_FU1, Tra_FU1_v, by="id", all=TRUE)
...
**R script**:  
```{r, echo=TRUE}
table(Tra3_4_Baseline$ENV_PPLTRST_MCQ, useNA="always") 

soc_CLSA_tra_0$env_nbh_trust_0 <- ifelse(Tra3_4_Baseline$ENV_PPLTRST_MCQ ==1 | Tra3_4_Baseline$ENV_PPLTRST_MCQ ==2,1L, 
                                           ifelse(Tra3_4_Baseline$ENV_PPLTRST_MCQ ==3 | Tra3_4_Baseline$ENV_PPLTRST_MCQ ==4,0L,NA))

table(soc_CLSA_tra_0$env_nbh_trust_0, useNA="always") 
```
### **Variable label**:  Neighbourhood  trust  
...
**R script**:  
```{r, echo=TRUE}
table(Tra_FU1$ENV_PPLTRST_TRF1, useNA="always") 

soc_CLSA_tra_1$env_nbh_trust_1 <- ifelse(Tra_FU1$ENV_PPLTRST_TRF1 ==1 | Tra_FU1$ENV_PPLTRST_TRF1 ==2,1L, 
                                           ifelse(Tra_FU1$ENV_PPLTRST_TRF1 ==3 | Tra_FU1$ENV_PPLTRST_TRF1 ==4,0L,NA))

table(soc_CLSA_tra_1$env_nbh_trust_1, useNA="always") 
```
### **Variable label**:  Neighbourhood  trust  
...
**R script**:  
```{r, echo=TRUE}
table(Tra3_4_Baseline$ENV_PPLHLP_MCQ, useNA="always") 

soc_CLSA_tra_0$env_nbs_coop_0 <- ifelse(Tra3_4_Baseline$ENV_PPLHLP_MCQ ==1 |Tra3_4_Baseline$ENV_PPLHLP_MCQ ==2,1L, 
                                 ifelse(Tra3_4_Baseline$ENV_PPLHLP_MCQ ==3 |Tra3_4_Baseline$ENV_PPLHLP_MCQ ==4,0L,NA))

table(soc_CLSA_tra_0$env_nbs_coop_0, useNA="always") 
...
**R script**:  
```{r, echo=TRUE}
table(Tra_FU1$ENV_PPLHLP_TRF1, useNA="always") 

soc_CLSA_tra_1$env_nbs_coop_1 <- ifelse(Tra_FU1$ENV_PPLHLP_TRF1 ==1 |Tra_FU1$ENV_PPLHLP_TRF1 ==2,1L, 
                                 ifelse(Tra_FU1$ENV_PPLHLP_TRF1 ==3 |Tra_FU1$ENV_PPLHLP_TRF1 ==4,0L,NA))

table(soc_CLSA_tra_1$env_nbs_coop_1, useNA="always") 
```
...
**R script**:  
```{r, echo=TRUE}
table(Tra3_4_Baseline$ENV_PPLFRNDLY_MCQ, useNA="always") 

soc_CLSA_tra_0$env_nbs_friendly_0 <- ifelse(Tra3_4_Baseline$ENV_PPLFRNDLY_MCQ ==1,1L, 
                                           ifelse(Tra3_4_Baseline$ENV_PPLFRNDLY_MCQ==2,2L,
                                            ifelse(Tra3_4_Baseline$ENV_PPLFRNDLY_MCQ==3,3L,
                                                   ifelse(Tra3_4_Baseline$ENV_PPLFRNDLY_MCQ==4,4L,NA))))

table(soc_CLSA_tra_0$env_nbs_friendly_0, useNA="always") 
```
...
table(Tra_FU1$SPA_COHES_TRF1, useNA="always") 

soc_CLSA_tra_1$env_nbh_belong_1 <- ifelse(Tra_FU1$SPA_COHES_TRF1 ==1 | Tra_FU1$SPA_COHES_TRF1==2,1L, 
                                            ifelse(Tra_FU1$SPA_COHES_TRF1==3 | Tra_FU1$SPA_COHES_TRF1==4,0L,NA))

table(soc_CLSA_tra_1$env_nbh_belong_1, useNA="always") 
```
### **Variable label**: Belonging to neighbourhood        
...
table(Tra3_4_Baseline$ENV_FLLNLY_MCQ, useNA="always") 

soc_CLSA_tra_0$env_nbh_lone_0 <- ifelse(Tra3_4_Baseline$ENV_FLLNLY_MCQ==1,1L, 
                                 ifelse(Tra3_4_Baseline$ENV_FLLNLY_MCQ==2,2L,
                                 ifelse(Tra3_4_Baseline$ENV_FLLNLY_MCQ==3,4L,
                                 ifelse(Tra3_4_Baseline$ENV_FLLNLY_MCQ==4,5L,
                                 ifelse(Tra3_4_Baseline$ENV_FLLNLY_MCQ==8,3L,NA)))))

table(soc_CLSA_tra_0$env_nbh_lone_0, useNA="always") 
```
### **Variable label**: Lonely in neighbourhood        
...
**R script**:  
```{r, echo=TRUE}
table(Tra_FU1$ENV_FLLNLY_TRF1, useNA="always") 

soc_CLSA_tra_1$env_nbh_lone_1 <- ifelse(Tra_FU1$ENV_FLLNLY_TRF1==1,1L, 
                                 ifelse(Tra_FU1$ENV_FLLNLY_TRF1==2,2L,
                                 ifelse(Tra_FU1$ENV_FLLNLY_TRF1==3,4L,
                                 ifelse(Tra_FU1$ENV_FLLNLY_TRF1==4,5L,
                                 ifelse(Tra_FU1$ENV_FLLNLY_TRF1==8,3L,NA)))))

table(soc_CLSA_tra_1$env_nbh_lone_1, useNA="always") 
```
### **Variable label**: Lonely in neighbourhood        
...
**R script**:  
```{r, echo=TRUE}
table(Tra3_4_Baseline$ENV_CLEAN_MCQ, useNA="always") 

soc_CLSA_tra_0$env_nbh_clean_0 <- ifelse(Tra3_4_Baseline$ENV_CLEAN_MCQ ==1,4L, 
                                           ifelse(Tra3_4_Baseline$ENV_CLEAN_MCQ==2,3L,
                                            ifelse(Tra3_4_Baseline$ENV_CLEAN_MCQ==3,2L,
                                                   ifelse(Tra3_4_Baseline$ENV_CLEAN_MCQ==4,1L,NA))))

table(soc_CLSA_tra_0$env_nbh_clean_0, useNA="always") 
```
### **Variable label**: Neighbourhood cleanliness   
...
**R script**:  
```{r, echo=TRUE}
table(Tra_FU1$ENV_CLEAN_TRF1, useNA="always") 

soc_CLSA_tra_1$env_nbh_clean_1 <- ifelse(Tra_FU1$ENV_CLEAN_TRF1 ==1,4L, 
                                           ifelse(Tra_FU1$ENV_CLEAN_TRF1==2,3L,
                                            ifelse(Tra_FU1$ENV_CLEAN_TRF1==3,2L,
                                                   ifelse(Tra_FU1$ENV_CLEAN_TRF1==4,1L,NA))))

table(soc_CLSA_tra_1$env_nbh_clean_1, useNA="always") 
```
...
soc_CLSA_tra_0$env_nbh_clean_0 <- ifelse(Tra3_4_Baseline$ENV_CLEAN_MCQ ==1 | Tra3_4_Baseline$ENV_CLEAN_MCQ==2,1L, 
                                  ifelse(Tra3_4_Baseline$ENV_CLEAN_MCQ==3 | Tra3_4_Baseline$ENV_CLEAN_MCQ==4,0L,NA))
...
soc_CLSA_tra_1$env_nbh_clean_1 <- ifelse(Tra_FU1$ENV_CLEAN_TRF1 ==1 | Tra_FU1$ENV_CLEAN_TRF1==2,1L, 
                                  ifelse(Tra_FU1$ENV_CLEAN_TRF1==3 | Tra_FU1$ENV_CLEAN_TRF1==4,0L,NA))
...
**R script**:  
```{r, echo=TRUE}
table(Tra3_4_Baseline$ENV_HMPRB_NOI_MCQ, useNA="always") 

soc_CLSA_tra_0$env_nbh_noise_dich_0 <- ifelse(Tra3_4_Baseline$ENV_HMPRB_NOI_MCQ ==1,0L, 
                                       ifelse(Tra3_4_Baseline$ENV_HMPRB_NOI_MCQ ==0,1L,NA))

table(soc_CLSA_tra_0$env_nbh_noise_dich_0, useNA="always") 
```
### **Variable label**: Neighbourhood noisiness (2-level)     
...
**R script**:  
```{r, echo=TRUE}
table(Tra_FU1$ENV_HMPRB_NOI_TRF1, useNA="always") 

soc_CLSA_tra_1$env_nbh_noise_dich_1 <- ifelse(Tra_FU1$ENV_HMPRB_NOI_TRF1 ==1,0L, 
                                       ifelse(Tra_FU1$ENV_HMPRB_NOI_TRF1==0,1L,NA))

table(soc_CLSA_tra_1$env_nbh_noise_dich_1, useNA="always") 
```
...
**R script**:  
```{r, echo=TRUE}
table(Tra3_4_Baseline$ENV_VNDLSM_MCQ, useNA="always") 

soc_CLSA_tra_0$env_nbh_gv_0 <- ifelse(Tra3_4_Baseline$ENV_VNDLSM_MCQ ==1 | Tra3_4_Baseline$ENV_VNDLSM_MCQ==2,1L, 
                               ifelse(Tra3_4_Baseline$ENV_VNDLSM_MCQ ==3 | Tra3_4_Baseline$ENV_VNDLSM_MCQ==4,0L,NA))

table(soc_CLSA_tra_0$env_nbh_gv_0, useNA="always") 
```
### **Variable label**: Neighbourhood graffiti and vandalism  
...
**R script**:  
```{r, echo=TRUE}
table(Tra_FU1$ENV_VNDLSM_TRF1, useNA="always") 

soc_CLSA_tra_1$env_nbh_gv_1 <- ifelse(Tra_FU1$ENV_VNDLSM_TRF1 ==1 | Tra_FU1$ENV_VNDLSM_TRF1==2,1L, 
                               ifelse(Tra_FU1$ENV_VNDLSM_TRF1 ==3 | Tra_FU1$ENV_VNDLSM_TRF1==4,0L,NA))

table(soc_CLSA_tra_1$env_nbh_gv_1, useNA="always") 
```
### **Variable label**: Neighbourhood graffiti and vandalism    

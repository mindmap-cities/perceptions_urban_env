...
# CLSA-tra_0
opal.assign.table.tibble(erasmus_opal, 'Tra3_4_Baseline', 'CLSA_1.Tra3_4_Baseline', variables = list('ENV_PPLTRST_MCQ','ENV_PPLHLP_MCQ','ENV_PPLFRNDLY_MCQ','ENV_FLLNLY_MCQ','ENV_CLEAN_MCQ','ENV_HMPRB_NOI_MCQ','ENV_VNDLSM_MCQ'))
Tra3_4_Baseline <- opal.execute(erasmus_opal,'Tra3_4_Baseline')
# CLSA-tra_1
opal.assign.table.tibble(erasmus_opal, 'Tra_FU1', 'CLSA_1.Tra_FU1', variables = list('ENV_PPLTRST_TRF1','ENV_PPLHLP_TRF1','ENV_PPLFRNDLY_TRF1','ENV_FLLNLY_TRF1','ENV_CLEAN_TRF1','ENV_HMPRB_NOI_TRF1','ENV_VNDLSM_TRF1','SPA_COHES_TRF1'))
...
**R script**:  
```{r, echo=TRUE}
table(Tra3_4_Baseline$ENV_CLEAN_MCQ) 
...
table(soc_CLSA_tra_0$env_nbh_clean_0) 
```
### **Variable label**: Neighbourhood cleanliness   

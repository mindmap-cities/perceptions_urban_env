...
# HAPIEE wave 1  
opal.assign.table.tibble(erasmus_opal, 'HAPIEE_W1','HAPIEE.HAPIEE_W1', variables=list('country','p59a','p59b','p59c','p59d')) 
...
**Harmonization status**: complete 
**Harmonization comment**:  category 3: 'sometimes feels safe' is recoded as 'does not feel safe' 
**R script**:  
```{r, echo=TRUE}
table(HAPIEE_W1$p59a) #1=Always feels safe in area of residence at night 5=never 
summary(HAPIEE_W1$p59a)
env_HAPIEE_CZ_0$env_nbh_sf_0 <- as.integer(ifelse((HAPIEE_W1$p59a == '1' | HAPIEE_W1$p59a == '2'), 1,
                                                         (ifelse (HAPIEE_W1$p59a == '3'|HAPIEE_W1$p59a == '4'| HAPIEE_W1$p59a == '5', 0, NA))))
...
**Harmonization status**: complete 
**Harmonization comment**:  'sometimes trust among people in area of residence' is recoded as 'people cannot be trusted'  
**R script**:  
```{r, echo=TRUE}
table(HAPIEE_W1$p59d) #1=Always feels safe in area of residence at night 5=never 
summary(HAPIEE_W1$p59d)
env_HAPIEE_CZ_0$env_nbh_trust_0 <- as.integer(ifelse((HAPIEE_W1$p59d == '1' | HAPIEE_W1$p59d == '2'), 1,

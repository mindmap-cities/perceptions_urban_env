...
# HAPIEE wave 2 
opal.assign.table.tibble(erasmus_opal, 'HAPIEE_W2', 'HAPIEE.HAPIEE_W2',variables=list('country','p59a_lt','p59b_lt','p59c_lt','p59d_lt')) 
...
env_HAPIEE_LT_0$env_nbh_sf_0 <- as.integer(ifelse((HAPIEE_W2$p59a_lt == '1' | HAPIEE_W2$p59a_lt == '2'), 1,
                                                         (ifelse (HAPIEE_W2$p59a_lt == '3'|HAPIEE_W2$p59a_lt == '4'| HAPIEE_W2$p59a_lt == '5', 0, NA))))
...
**R script**:  
```{r, echo=TRUE}
table(HAPIEE_W2$p59d_lt) #1=Always trust among people in area  5=never 
summary(HAPIEE_W2$p59d_lt)
env_HAPIEE_LT_0$env_nbh_trust_0 <- as.integer(ifelse((HAPIEE_W2$p59d_lt == '1' | HAPIEE_W2$p59d_lt == '2'), 1,

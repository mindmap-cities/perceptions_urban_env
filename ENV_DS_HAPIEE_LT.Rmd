...
# HAPIEE wave 2 
opal.assign.table.tibble(erasmus_opal, 'HAPIEE_W2', 'HAPIEE.HAPIEE_W2',variables=list('country','p59a_lt','p59b_lt','p59c_lt','p59d_lt','p59e_lt')) 
...
```{r,echo=FALSE}
env_HAPIEE_LT_0 <- data.frame(id = HAPIEE_W2$id)
```
# Table of Contents
...
**R script**:  
```{r, echo=TRUE}
table(HAPIEE_W2$p59b_lt) #1=Always feels safe in area of residence at night 5=never 8=NA 9=NA
summary(HAPIEE_W2$p59b_lt)
env_HAPIEE_LT_0$env_nbh_nsf_0 <- as.integer(ifelse((HAPIEE_W2$p59b_lt == '1' | HAPIEE_W2$p59b_lt == '2'), 1,
                                                         (ifelse (HAPIEE_W2$p59b_lt == '3'|HAPIEE_W2$p59b_lt == '4'| HAPIEE_W2$p59b_lt == '5', 0, NA))))
table(env_HAPIEE_LT_0$env_nbh_nsf_0)
summary(env_HAPIEE_LT_0$env_nbh_nsf_0)
...
**R script**:  
```{r, echo=TRUE}
table(HAPIEE_W2$p59a_lt) #1=Always feels safe in area of residence at night 5=never 8=NA 9=NA
summary(HAPIEE_W2$p59a_lt)

env_HAPIEE_LT_0$env_nbh_sf_0 <- as.integer(ifelse((HAPIEE_W2$p59a_lt == '1' | HAPIEE_W2$p59a_lt == '2') & (HAPIEE_W2$p59b_lt == '1'
                                                   | HAPIEE_W2$p59b_lt == '2'), 1,
                                                         (ifelse (HAPIEE_W2$p59a_lt == '3'|HAPIEE_W2$p59a_lt == '4'| HAPIEE_W2$p59a_lt == '5' | HAPIEE_W2$p59b_lt == '3'|HAPIEE_W2$p59b_lt == '4'| HAPIEE_W2$p59b_lt == '5' , 0, NA))))

table(env_HAPIEE_LT_0$env_nbh_sf_0)
summary(env_HAPIEE_LT_0$env_nbh_sf_0)
```
### **Variable label**:  Feels safe in neighbourhood     
...
**R script**:  
```{r, echo=TRUE}
table(HAPIEE_W2$p59e_lt) #1=Always can trust people in area  ... 5=never can trust people 9=NA
summary(HAPIEE_W2$p59e_lt)
env_HAPIEE_LT_0$env_nbh_trust_0 <- as.integer(ifelse((HAPIEE_W2$p59e_lt == '1' | HAPIEE_W2$p59e_lt == '2'), 1,
                                                         (ifelse (HAPIEE_W2$p59e_lt == '3'|HAPIEE_W2$p59e_lt == '4'| HAPIEE_W2$p59e_lt == '5', 0, NA))))
table(env_HAPIEE_LT_0$env_nbh_trust_0)
summary(env_HAPIEE_LT_0$env_nbh_trust_0)
...
**R script**: 
```{r, echo=TRUE}
table(HAPIEE_W2$p59d_lt) #1=Always trust among people in area  ... 5=never trust among people 9=NA
summary(HAPIEE_W2$p59d_lt)
env_HAPIEE_LT_0$env_nbh_trust_among_0 <- as.integer(ifelse((HAPIEE_W2$p59d_lt == '1' | HAPIEE_W2$p59d_lt == '2'), 1,
                                                         (ifelse (HAPIEE_W2$p59d_lt == '3'|HAPIEE_W2$p59d_lt == '4'| HAPIEE_W2$p59d_lt == '5', 0, NA))))
table(env_HAPIEE_LT_0$env_nbh_trust_among_0)
summary(env_HAPIEE_LT_0$env_nbh_trust_amoung_0)
...
**Variable description**: Indicator of whether the participant agrees that neighbours would help them if needed, in case of emergency/trouble.  
**Value type**: integer  
**Variable unit**:  N/A  
**Category coding**:  
...
**R script**:  
```{r, echo=TRUE}
table(HAPIEE_W2$p59c_lt) #1=Always neighbours would help  5=never 
summary(HAPIEE_W2$p59c_lt)
env_HAPIEE_LT_0$env_nbs_help_0 <- as.integer(ifelse((HAPIEE_W2$p59c_lt == '1' | HAPIEE_W2$p59c_lt == '2'), 1,
                                                         (ifelse (HAPIEE_W2$p59c_lt == '3'|HAPIEE_W2$p59c_lt == '4'| HAPIEE_W2$p59c_lt == '5', 0, NA))))
table(env_HAPIEE_LT_0$env_nbs_help_0)
summary(env_HAPIEE_LT_0$env_nbs_help_0)

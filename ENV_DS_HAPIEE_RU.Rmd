...
env_HAPIEE_RU_0$env_nbh_sf_0 <- as.integer(ifelse((HAPIEE_W1$p59a == '1' | HAPIEE_W1$p59a == '2'), 1,
...
**R script**:  
```{r, echo=TRUE}
table(HAPIEE_W1$p59d) #1=Always trust among poeple in area 5=never 
summary(HAPIEE_W1$p59d)
env_HAPIEE_RU_0$env_nbh_trust_0 <- as.integer(ifelse((HAPIEE_W1$p59d == '1' | HAPIEE_W1$p59d == '2'), 1,

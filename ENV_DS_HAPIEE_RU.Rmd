...
```{r,echo=FALSE}
env_HAPIEE_RU_0 <- data.frame(id = HAPIEE_W1$id)
env_HAPIEE_RU_1 <- data.frame(id = HAPIEE_W2$id)
```
# Table of Contents
...
env_HAPIEE_RU_0$env_nbh_nsf_0 <- as.integer(ifelse((HAPIEE_W1$p59b == '1' | HAPIEE_W1$p59b == '2'), 1,
                                                         (ifelse (HAPIEE_W1$p59b == '3'|HAPIEE_W1$p59b == '4'| HAPIEE_W1$p59b == '5', 0, NA))))
table(env_HAPIEE_RU_0$env_nbh_nsf_0)
summary(env_HAPIEE_RU_0$env_nbh_nsf_0)
```
### **Variable label**:  Feels safe at night     
...
env_HAPIEE_RU_0$env_nbh_sf_0 <- as.integer(ifelse((HAPIEE_W1$p59a == '1' | HAPIEE_W1$p59a == '2') & (HAPIEE_W1$p59b == '1'
                                                   | HAPIEE_W1$p59b == '2'), 1,
                                                         (ifelse (HAPIEE_W1$p59a == '3'|HAPIEE_W1$p59a == '4'| HAPIEE_W1$p59a == '5' | HAPIEE_W1$p59b == '3'|HAPIEE_W1$p59b == '4'| HAPIEE_W1$p59b == '5' , 0, NA))))
table(env_HAPIEE_RU_0$env_nbh_sf_0)
summary(env_HAPIEE_RU_0$env_nbh_sf_0)
```
### **Variable label**:  Feels safe in neighbourhood     
...
env_HAPIEE_RU_0$env_nbh_trust_0 <- as.integer(ifelse((HAPIEE_W1$p59e == '1' | HAPIEE_W1$p59e == '2'), 1,
                                                         (ifelse (HAPIEE_W1$p59e == '3'|HAPIEE_W1$p59e == '4'| HAPIEE_W1$p59e == '5', 0, NA))))
table(env_HAPIEE_RU_0$env_nbh_trust_0)
summary(env_HAPIEE_RU_0$env_nbh_trust_0)
...
env_HAPIEE_RU_0$env_nbh_trust_among_0 <- as.integer(ifelse((HAPIEE_W1$p59d == '1' | HAPIEE_W1$p59d == '2'), 1,
                                                         (ifelse (HAPIEE_W1$p59d == '3'|HAPIEE_W1$p59d == '4'| HAPIEE_W1$p59d == '5', 0, NA))))
table(env_HAPIEE_RU_0$env_nbh_trust_among_0)
summary(env_HAPIEE_RU_0$env_nbh_trust_among_0)
```
### **Variable label**:  Neighbourhood  trust  
...
env_HAPIEE_RU_0$env_nbs_help_0 <- as.integer(ifelse((HAPIEE_W1$p59c == '1' | HAPIEE_W1$p59c == '2'), 1,
                                                         (ifelse (HAPIEE_W1$p59c == '3'|HAPIEE_W1$p59c == '4'| HAPIEE_W1$p59c == '5', 0, NA))))
table(env_HAPIEE_RU_0$env_nbs_help_0)
summary(env_HAPIEE_RU_0$env_nbs_help_0)
...
**Variable description**: Indicator of whether the participant agrees that members of the area in which participant lives are close-knit (community solidarity). **Value type**: integer      
**Variable unit**: N/A       
**Category coding**:  

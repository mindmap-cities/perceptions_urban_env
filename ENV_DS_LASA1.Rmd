...
opal.assign.table.tibble(erasmus_opal,'LASA1B','LASA.LASA1B', variables=list('bsafe'))
LASA1B <- opal.execute(erasmus_opal,'LASA1B')

opal.assign.table.tibble(erasmus_opal,'LASA1C','LASA.LASA1C', variables=list('csafe'))
LASA1C <- opal.execute(erasmus_opal,'LASA1C')

opal.assign.table.tibble(erasmus_opal,'LASA1D','LASA.LASA1D', variables=list('dsafe'))
LASA1D <- opal.execute(erasmus_opal,'LASA1D')

opal.assign.table.tibble(erasmus_opal,'LASA1E','LASA.LASA1E', variables=list('esafe'))
LASA1E <- opal.execute(erasmus_opal,'LASA1E')

opal.assign.table.tibble(erasmus_opal,'LASA1F','LASA.LASA1F', variables=list('fsafe'))
LASA1F <- opal.execute(erasmus_opal,'LASA1F')

opal.assign.table.tibble(erasmus_opal,'LASA1G','LASA.LASA1G', variables=list('gsafe'))
LASA1G <- opal.execute(erasmus_opal,'LASA1G')

opal.assign.table.tibble(erasmus_opal,'LASA1H','LASA.LASA1H', variables=list('HSAFE'))
LASA1H <- opal.execute(erasmus_opal,'LASA1H')
```
## Assign participant id as first column of your harmonized dataframes
```{r,echo=FALSE}
env_LASA1_0 <- data.frame(id= LASA1B$id)
env_LASA1_1 <- data.frame(id= LASA1C$id)
env_LASA1_2 <- data.frame(id= LASA1D$id)
env_LASA1_3 <- data.frame(id= LASA1E$id)
env_LASA1_4 <- data.frame(id= LASA1F$id)
env_LASA1_5 <- data.frame(id= LASA1G$id)
env_LASA1_6 <- data.frame(id= LASA1H$id)
```
# Table of Contents
...
```{r, echo=TRUE}
table(LASA1B$bsafe)
summary(LASA1B$bsafe)
#0=no 1=yes NOTE: in LASA2 THESE ARE CODED AS 1 and 2 !!!!
typeof(LASA1B$bsafe)
env_LASA1_0$env_nbh_nsf_0 <- as.integer(ifelse(LASA1B$bsafe == 0, 0,
                                            ifelse(LASA1B$bsafe == 1, 1,
                                                   ifelse(LASA1B$bsafe == -4 |LASA1B$bsafe == -1 , NA,
                                                          NA))))
table(env_LASA1_0$env_nbh_nsf_0)
summary(env_LASA1_0$env_nbh_nsf_0)
...
```{r, echo=TRUE}
table(LASA1C$csafe)
summary(LASA1C$csafe)
#1=no 2=yes typeof(LASA1C$csafe)
env_LASA1_1$env_nbh_nsf_1 <- ifelse(LASA1C$csafe == 1, 0,
                                            ifelse(LASA1C$csafe == 2, 1,
                                               NA))
table(env_LASA1_1$env_nbh_nsf_1)
summary(env_LASA1_1$env_nbh_nsf_1)
...
```{r, echo=TRUE}
table(LASA1D$dsafe)
summary(LASA1D$dsafe)
#1=no 2=yes 
env_LASA1_2$env_nbh_nsf_2 <- ifelse(LASA1D$dsafe == 1, 0,
                                            ifelse(LASA1D$dsafe == 2, 1,
                                               NA))
                                                          
table(env_LASA1_2$env_nbh_nsf_2)
summary(env_LASA1_2$env_nbh_nsf_2)
...
```{r, echo=TRUE}
table(LASA1E$esafe)
summary(LASA1E$esafe)
#1=no 2=yes 
env_LASA1_3$env_nbh_nsf_3 <- ifelse(LASA1E$esafe == 1, 0,
                                            ifelse(LASA1E$esafe == 2, 1,
                                               NA))
                                                          
table(env_LASA1_3$env_nbh_nsf_3)
summary(env_LASA1_3$env_nbh_nsf_3)
...
```{r, echo=TRUE}
table(LASA1F$fsafe)
summary(LASA1F$fsafe)
#1=no 2=yes 
env_LASA1_4$env_nbh_nsf_4 <- ifelse(LASA1F$fsafe == 1, 0,
                                            ifelse(LASA1F$fsafe == 2, 1,
                                               NA))
                                                          
table(env_LASA1_4$env_nbh_nsf_4)
summary(env_LASA1_4$env_nbh_nsf_4) 
...
```{r, echo=TRUE}
table(LASA1G$gsafe)
summary(LASA1G$gsafe)
#1=no 2=yes 
env_LASA1_5$env_nbh_nsf_5 <- ifelse(LASA1G$gsafe == 1, 0,
                                            ifelse(LASA1G$gsafe == 2, 1,
                                               NA))
                                                          
table(env_LASA1_5$env_nbh_nsf_5)
summary(env_LASA1_5$env_nbh_nsf_5) 
...
```{r, echo=TRUE}
table(LASA1H$HSAFE)
summary(LASA1H$HSAFE)
#1=no 2=yes 
env_LASA1_6$env_nbh_nsf_6 <- ifelse(LASA1H$HSAFE == 1, 0,
                                            ifelse(LASA1H$HSAFE == 2, 1,
                                               NA))
                                                          
table(env_LASA1_6$env_nbh_nsf_6)
summary(env_LASA1_6$env_nbh_nsf_6) 
...
summary(LASA1B$bsafe)
#0=no 1=yes 
env_LASA1_0$env_nbh_sf_0 <- as.integer(ifelse(LASA1B$bsafe == 0, 0,
                                            ifelse(LASA1B$bsafe == 1, 1,
                                                   ifelse(LASA1B$bsafe == -4 |LASA1B$bsafe == -1 , NA,
                                                          NA))))
table(env_LASA1_0$env_nbh_sf_0)
summary(env_LASA1_0$env_nbh_sf_0)
...
summary(LASA1C$csafe)
#1=no 2=yes typeof(LASA1C$csafe)
env_LASA1_1$env_nbh_sf_1 <- ifelse(LASA1C$csafe == 1, 0,
                                            ifelse(LASA1C$csafe == 2, 1,
                                               NA))
table(env_LASA1_1$env_nbh_sf_1)
summary(env_LASA1_1$env_nbh_sf_1)
...
summary(LASA1D$dsafe)
#1=no 2=yes 
env_LASA1_2$env_nbh_sf_2 <- ifelse(LASA1D$dsafe == 1, 0,
                                            ifelse(LASA1D$dsafe == 2, 1,
                                               NA))
                                                          
table(env_LASA1_2$env_nbh_sf_2)
summary(env_LASA1_2$env_nbh_sf_2)
...
summary(LASA1E$esafe)
#1=no 2=yes 
env_LASA1_3$env_nbh_sf_3 <- ifelse(LASA1E$esafe == 1, 0,
                                            ifelse(LASA1E$esafe == 2, 1,
                                               NA))
                                                          
table(env_LASA1_3$env_nbh_sf_3)
summary(env_LASA1_3$env_nbh_sf_3)
...
summary(LASA1F$fsafe)
#1=no 2=yes 
env_LASA1_4$env_nbh_sf_4 <- ifelse(LASA1F$fsafe == 1, 0,
                                            ifelse(LASA1F$fsafe == 2, 1,
                                               NA))
                                                          
table(env_LASA1_4$env_nbh_sf_4)
summary(env_LASA1_4$env_nbh_sf_4) 
...
summary(LASA1G$gsafe)
#1=no 2=yes 
env_LASA1_5$env_nbh_sf_5 <- ifelse(LASA1G$gsafe == 1, 0,
                                            ifelse(LASA1G$gsafe == 2, 1,
                                               NA))
                                                          
table(env_LASA1_5$env_nbh_sf_5)
summary(env_LASA1_5$env_nbh_sf_5) 
...
summary(LASA1H$HSAFE)
#1=no 2=yes 
env_LASA1_6$env_nbh_sf_6 <- ifelse(LASA1H$HSAFE == 1, 0,
                                            ifelse(LASA1H$HSAFE == 2, 1,
                                               NA))
                                                          
table(env_LASA1_6$env_nbh_sf_6)
summary(env_LASA1_6$env_nbh_sf_6) 

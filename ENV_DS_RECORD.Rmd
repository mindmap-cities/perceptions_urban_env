...
**R script**:  
```{r, echo=TRUE}
env_RECORD_0$env_nbh_nsf_0 <-recode(as.integer(RECORD_w1_2$q12_no_securite),'1'=1L,'2'=1L,'3'=0L,'4'=0L)
...
**R script**:  
```{r, echo=TRUE}
env_RECORD_0$env_nbh_sf_0 <-recode(as.integer(RECORD_w1_2$q12_no_securite),'1'=1L,'2'=1L,'3'=0L,'4'=0L)
